...
export default function OneTimeSection({
  ...
  for (let i = startMonthIndex; i <= 11; i++) {
    availableMonths.push({
      index: i,
      label: `${monthsList[i]} ${currentYear}`,
    });
  }
          ...
          expenses.map((expense, index) => (
            ...
            >
              ...
              <div className="w-full md:w-44">
                ...
                <select
                  value={expense.bulanKejadian}
                  onChange={(e) => updateExpense(expense.id, { bulanKejadian: Number(e.target.value) })}
