...
export const translations = {
  id: {
    ...
    chartViewTrend: "Tren Saldo Kumulatif",
    chartViewDetail: "Analisis Arus Kas Bulanan",
    chartInflowLabel: "Pemasukan Bersih",
    chartOutflowLabel: "Pengeluaran",
  ...
  en: {
    ...
    deficit: "Deficit",
    paidOff: "Paid Off",
    chartViewTrend: "Cumulative Balance Trend",
    chartViewDetail: "Monthly Cash Flow Analysis",
    chartInflowLabel: "Net Inflow",
    chartOutflowLabel: "Outflow",
