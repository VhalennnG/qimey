...
export const translations = {
  id: {
    ...
    alertDetail:
      "Seluruh pendapatan Anda berakhir pada {lastActiveMonth}. Proyeksi bulan {nextMonth} hingga Desember dihitung tanpa pemasukan sama sekali.",
    ...
    compositionTitle: "Komposisi Pengeluaran & Sisa — Bulan Berjalan",
  ...
  en: {
    ...
    alertDetail:
      "All your income ends in {lastActiveMonth}. Projections for {nextMonth} through December are calculated with zero income.",
    ...
    deficit: "Deficit",
    paidOff: "Paid Off",
    compositionTitle: "Expenses & Savings Composition — Current Month",
